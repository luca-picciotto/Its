...
int inserimentoTripletta(int);
void stampaTripletta( int, int, int);
int stampaMaggiore(int, int, int);
int stampaMinore(int, int, int);
float stampaMedia( int, int, int);
void ordineCrescente(int, int, int);
void ordineDecrescente(int , int, int);
